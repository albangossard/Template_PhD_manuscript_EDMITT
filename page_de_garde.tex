...
% - laboratory
% - cotutelle
\title{\textbf{\large Un titre de manuscrit
}}
\author{Alban GOSSARD}
\defencedate{12/12/2022}
\lab{Institut de Mathématiques de Toulouse (UMR 5219)}
%\cotutelle{}
...
%% Boss
\nboss{2}
\makesomeone{boss}{1}{Un chef sympa}{}{} % Sera afiche en premier
\makesomeone{boss}{2}{Un chef sympa}{}{}  % Sera affiche en second
%% Referee
\nreferee{2}
\makesomeone{referee}{1}{Someone nice}{}{Professeur}
\makesomeone{referee}{2}{Someone nice}{}{Professeur}
%% Jury
\njudge{7}
\makesomeone{judge}{1}{Someone nice}{Professeur}{Rapporteur}
\makesomeone{judge}{2}{Someone nice}{Professeur}{Rapporteur}
\makesomeone{judge}{3}{Someone nice}{Professeur}{Examinateur}
\makesomeone{judge}{5}{Someone nice}{Professeur}{Président}
\makesomeone{judge}{6}{Un chef sympa}{Professeur}{Directeur de thèse}
\makesomeone{judge}{7}{Un chef sympa}{Professeur}{Co-directeur de thèse}
